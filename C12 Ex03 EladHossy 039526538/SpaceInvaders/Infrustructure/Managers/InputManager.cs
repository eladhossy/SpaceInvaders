...
namespace Infrastructure.Managers
{
    ...
    public class InputManager : GameService, IInputManager
    {
        ...
        private bool checkButtonsState(eInputButtons i_Buttons, ButtonState i_ButtonState, bool i_IsOneEnough, bool i_CheckChanged)
        {
            ...
            GamePadState currPadState = checkRelease ? m_GamePadState : m_PrevGamePadState;
            GamePadState prevPadState = checkRelease ? m_PrevGamePadState : m_GamePadState;

            #region GamePad Controls
            if ((i_Buttons & eInputButtons.A) != 0)
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.A)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.A));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.B)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.B));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.X)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.X));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.Y)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.Y));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.DPadDown)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.DPadDown));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.DPadUp)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.DPadUp));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.DPadLeft)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.DPadLeft));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.DPadRight)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.DPadRight));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.Back)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.Back));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.Start)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.Start));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftShoulder)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftShoulder));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightShoulder)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightShoulder));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftStick)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftStick));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightStick)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightStick));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftThumbstickDown)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftThumbstickDown));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftThumbstickUp)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftThumbstickUp));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftThumbstickLeft)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftThumbstickLeft));
            ...
            {
                currCheck = checkRelease == currPadState.IsButtonUp(Buttons.LeftThumbstickRight)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftThumbstickRight));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightThumbstickDown)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightThumbstickDown));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightThumbstickUp)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightThumbstickUp));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightThumbstickLeft)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightThumbstickLeft));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.RightThumbstickRight)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightThumbstickRight));
            ...
            {
                currCheck =
                    checkRelease == currPadState.IsButtonUp(Buttons.LeftTrigger)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.LeftTrigger));
            ...
            {
                currCheck =
                     checkRelease == currPadState.IsButtonUp(Buttons.RightTrigger)
                    && (!i_CheckChanged || checkRelease != prevPadState.IsButtonDown(Buttons.RightTrigger));
